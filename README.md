...
	To identify sales trends by day and month.
...
	Visual Highlights:
•	Daily Trend: Orders peak on weekends (Friday/Saturday evenings).
•	Monthly Trend: Highest orders occur in January and July.
•	Sales by Category
•	Sales by Pizza Size
•	Top Performers
•	Lowest Performers
Tools Used
•	Powe query– Data preparation and exploration
•	SQL Server – Data analysis and metric calculation
